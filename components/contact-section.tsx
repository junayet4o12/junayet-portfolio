...
export default function ContactSection() {
  return (
    <section className="relative pb-24 bg-gradient-to-br from-background via-background/95 to-background/90 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 space-y-8">
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
            <span className="block text-foreground">Let&rsquo;s talk on something</span>
                ...
                <div className="space-y-6 text-foreground">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium break-all">muhammadjunayetmaruf@gmail.com</p>
                    </div>
                  </div>
